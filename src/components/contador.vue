...
<template>
  <div>
    ...
    <p>{{ numero }} <sup>2</sup>={{ calcularCuadrado }}</p>
    <p>{{ numero }} <sup>3</sup>={{ calcularCuadrado }}</p>
...
export default {
  ...
  /*props: ["titulo2", "inicio", "mostrar"], declaracion basica de props*/
...
<style>
h1 {
  background-color: rgb(183, 195, 235);
  height: 40px;
  width: 200px;
}

p {
  background-color: rgb(203, 233, 208);
  width: 70px;
}
